 ...
 *
 * 此类使用File#createTempFile .. 在系统临时目录生成一个X.509 证书文件 以及 EC/RSA 私钥..
 * 当jvm 退出的时候  使用File#deleteOnExit删除它..
 * </p><p>
 ...
 * 首先此方法 尝试使用OpenJdk  的 X.509 实现(sun.security.x509 package)
 * 如果失败,它将尝试使用 bouncy castle 提供的算法作为 降级策略 ..
 * </p>
 */
